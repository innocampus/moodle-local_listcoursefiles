...
$string['license_colors_desc'] = 'You may use this to define a font color for a license. Specify one license (short name) following a space and the RGB color code (without #) per line (e.g. allrightsreserved ff0000).';
