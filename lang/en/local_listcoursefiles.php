...
$string['all_without_submissions'] = 'All without submissions';
...
$string['error:invalid_filetype'] = 'Invalid filetype given';
$string['error:invalid_license'] = 'Invalid license given';
$string['error:no_files_selected'] = 'You have not selected a file.';
$string['error:too_many_files'] = 'Too many files given';
$string['event:license_changed'] = 'License changed';
$string['filename'] = 'File name';
$string['filesize'] = 'File size';
$string['filetype:all'] = 'All file types';
$string['filetype:archive'] = 'Archive';
$string['filetype:audio'] = 'Audio';
$string['filetype:document'] = 'Document';
$string['filetype:hvp'] = 'H5P Archive';
$string['filetype:image'] = 'Image';
$string['filetype:other'] = 'Other';
...
$string['nav_link_course_files'] = 'Course files';
